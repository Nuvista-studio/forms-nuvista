            ...
            <div class="p-6 space-y-5 text-sm text-gray-800 dark:text-gray-200">
                ...
                <table class="w-full">
                    <tr>
                        ...
                        <td class="text-center"><h1 class="text-lg font-bold">{{ $_title }}</h1><p class="text-xs text-gray-500">IT Department &mdash; ASRI</p></td>
                        <td class="w-14"></td>
                    </tr>
                </table>
                ...
                <div>
                    ...
                    <table class="w-full border border-gray-300 dark:border-gray-600">
                        <tr>
                            <td class="border border-gray-300 dark:border-gray-600 px-3 py-1.5 bg-gray-100 dark:bg-gray-800 font-semibold w-[16%]">Nama User</td>
                            <td class="border border-gray-300 dark:border-gray-600 px-3 py-1.5 w-[34%]">{{ $_form['pengguna']['name'] ?? '-' }}</td>
                            <td class="border border-gray-300 dark:border-gray-600 px-3 py-1.5 bg-gray-100 dark:bg-gray-800 font-semibold w-[16%]">NIK User</td>
                            <td class="border border-gray-300 dark:border-gray-600 px-3 py-1.5 w-[34%]">{{ $_form['pengguna']['nik'] ?? '-' }}</td>
                        </tr>
                        <tr>
                            <td class="border border-gray-300 dark:border-gray-600 px-3 py-1.5 bg-gray-100 dark:bg-gray-800 font-semibold">Department</td>
                            <td class="border border-gray-300 dark:border-gray-600 px-3 py-1.5">{{ $_form['pengguna']['department'] ?? '-' }}</td>
                            <td class="border border-gray-300 dark:border-gray-600 px-3 py-1.5 bg-gray-100 dark:bg-gray-800 font-semibold">Site / B. Unit</td>
                            <td class="border border-gray-300 dark:border-gray-600 px-3 py-1.5">{{ $_form['pengguna']['site'] ?? $_form['pengguna']['business_unit'] ?? '-' }}</td>
                        </tr>
                        <tr>
                ...
                <div>
                    ...
                    <table class="w-full border border-gray-300 dark:border-gray-600">
                        <tr>
                            <td class="border border-gray-300 dark:border-gray-600 px-3 py-1.5 bg-gray-100 dark:bg-gray-800 font-semibold w-[12%]">Kategori</td>
                            <td class="border border-gray-300 dark:border-gray-600 px-3 py-1.5 w-[14%]">{{ $_form['asset']['kategori'] ?? '-' }}</td>
                            <td class="border border-gray-300 dark:border-gray-600 px-3 py-1.5 bg-gray-100 dark:bg-gray-800 font-semibold w-[10%]">Brand</td>
                            <td class="border border-gray-300 dark:border-gray-600 px-3 py-1.5 w-[14%]">{{ $_form['asset']['brand'] ?? '-' }}</td>
                            <td class="border border-gray-300 dark:border-gray-600 px-3 py-1.5 bg-gray-100 dark:bg-gray-800 font-semibold w-[10%]">Tipe</td>
                            <td class="border border-gray-300 dark:border-gray-600 px-3 py-1.5 w-[14%]">{{ $_form['asset']['tipe'] ?? '-' }}</td>
                            <td class="border border-gray-300 dark:border-gray-600 px-3 py-1.5 bg-gray-100 dark:bg-gray-800 font-semibold w-[13%]">Nama Perangkat</td>
                            <td class="border border-gray-300 dark:border-gray-600 px-3 py-1.5 w-[13%]">{{ $_form['asset']['nama_perangkat'] ?? '-' }}</td>
                        </tr>
                        <tr>
                            ...
                            <td class="border border-gray-300 dark:border-gray-600 px-3 py-1.5 bg-gray-100 dark:bg-gray-800 font-semibold">Kondisi</td>
                            <td colspan="3" class="border border-gray-300 dark:border-gray-600 px-3 py-1.5">
                                @php $_k = $_form['kondisi'] ?? ''; $_kk = $_form['kondisi_keterangan'] ?? ''; @endphp
                        ...
                        <tr>
                            <td class="border border-gray-300 dark:border-gray-600 px-3 py-1.5 bg-gray-100 dark:bg-gray-800 font-semibold">Site Location</td>
                            <td colspan="3" class="border border-gray-300 dark:border-gray-600 px-3 py-1.5">{{ $_form['site_location'] ?? '-' }}</td>
                            <td class="border border-gray-300 dark:border-gray-600 px-3 py-1.5 bg-gray-100 dark:bg-gray-800 font-semibold">Location Detail</td>
                            <td colspan="3" class="border border-gray-300 dark:border-gray-600 px-3 py-1.5">{{ $_form['location_detail'] ?? '-' }}</td>
                        </tr>
                    </table>
                    @else
                    <table class="w-full border border-gray-300 dark:border-gray-600">
                        <tr>
                            <td class="border border-gray-300 dark:border-gray-600 px-3 py-1.5 bg-gray-100 dark:bg-gray-800 font-semibold w-[12%]">Kategori</td>
                            <td class="border border-gray-300 dark:border-gray-600 px-3 py-1.5 bg-gray-100 dark:bg-gray-800 font-semibold w-[10%]">Brand, Tipe</td>
                            <td class="border border-gray-300 dark:border-gray-600 px-3 py-1.5 bg-gray-100 dark:bg-gray-800 font-semibold w-[13%]">Nama Perangkat</td>
                            <td class="border border-gray-300 dark:border-gray-600 px-3 py-1.5 bg-gray-100 dark:bg-gray-800 font-semibold w-[10%]">No. Serial</td>
                            <td class="border border-gray-300 dark:border-gray-600 px-3 py-1.5 bg-gray-100 dark:bg-gray-800 font-semibold w-[10%]">No. Asset</td>
                        </tr>
                        <tr>
                    ...
                    <table class="w-full">
                        <tr class="align-top">
                            ...
                            <td class="w-1/2 pr-2 align-top">
                                @if(count($_hardware))
                                <div class="text-xs font-bold mb-1 px-3 py-1 bg-gray-100 dark:bg-gray-800 border-l-4 border-gray-500" style="margin-top:0;">{{ $_isPemeriksaan ? 'Pemeriksaan' : 'Perawatan' }} Hardware</div>
                                <table class="w-full border border-gray-300 dark:border-gray-600">
                                    <thead><tr class="bg-gray-100 dark:bg-gray-800">
                                        ...
                                        <th class="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-xs font-semibold w-[20%]">{{ $_isPemeriksaan ? 'Kondisi' : 'Status' }}</th>
                                    ...
                                    <tbody>
                                        ...
                                        @if($_isPemeriksaan && ($_item['name'] ?? '') === 'Battery' && (!empty($_item['full_charge_capacity']) || !empty($_item['design_capacity'])))
                                        <tr class="bg-gray-50 dark:bg-gray-800/50">
                                            <td colspan="3" class="border border-gray-300 dark:border-gray-600 px-2 py-1" style="border-top:none;">
                                                <table class="w-full text-[10px]">
                                                    <tr>
                                                        <td class="font-semibold text-right pr-1 w-[25%]">Full Charge Capacity</td>
                                                        <td class="w-[25%]">{{ $_item['full_charge_capacity'] ?? '-' }} mWh</td>
                                                        <td class="font-semibold text-right pr-1 w-[25%]">Design Capacity</td>
                                                        <td class="w-[25%]">{{ $_item['design_capacity'] ?? '-' }} mWh</td>
                                                        <td class="font-semibold text-right pr-1 w-[25%]">Battery Health</td>
                                ...
                                @if(!$_isPemeriksaan)
                                    ...
                                    <div class="text-xs font-bold mb-1 px-3 py-1 bg-gray-100 dark:bg-gray-800 border-l-4 border-gray-500">Kondisi Setelah Perawatan</div>
                                    @if($_selectedKondisi)
                            ...
                            <td class="w-1/2 pl-2 align-top">
                                <div class="text-xs font-bold mb-1 px-3 py-1 bg-gray-100 dark:bg-gray-800 border-l-4 border-gray-500" style="margin-top:0;">{{ $_isPemeriksaan ? 'Pemeriksaan' : 'Perawatan' }} Aplikasi</div>
                                <table class="w-full border border-gray-300 dark:border-gray-600">
                                    <thead><tr class="bg-gray-100 dark:bg-gray-800">
                                        <th class="border border-gray-300 dark:border-gray-600 px-2 py-1 text-left text-xs font-semibold w-[36%]">Name</th>
                                        <th class="border border-gray-300 dark:border-gray-600 px-2 py-1 text-center text-xs font-semibold w-[20%]">Status</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="even:bg-gray-50 dark:even:bg-gray-800/50">
                                            ...
                                            <td class="border border-gray-300 dark:border-gray-600 px-2 py-1 text-xs text-center">
                                                @if($_isPemeriksaan)
                                                    @if(($_item['status'] ?? '') === 'baik') Installed
                                                    @elseif(($_item['status'] ?? '') === 'tidak_baik') Not Installed
                                                    @else - @endif
                                                @else
                                ...
                                @if(!$_isPemeriksaan)
                                <div class="mt-1 px-3 py-1.5 border border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-800 text-xs text-gray-500">
                                    <strong>Kondisi :</strong> <span class="mr-3">V : DONE</span> <span>X : NOT YET</span>
                                </div>
                ...
                <div>
                    <div class="text-xs font-bold mb-1 px-3 py-1 bg-gray-100 dark:bg-gray-800 border-l-4 border-gray-500">Tindakan</div>
                    <table class="w-full border border-gray-300 dark:border-gray-600">
                ...
                <table class="w-full mt-4">
                    <tr class="text-center align-top">
                        <td class="w-1/3 px-1">
                            ...
                            @if($_sigRole1)<div class="text-[10px] text-gray-500 mb-2">{{ $_sigRole1 }}</div>@endif
                        ...
                        <td class="w-1/3 px-1">
                            ...
                            @if($_sigRole2)<div class="text-[10px] text-gray-500 mb-2">{{ $_sigRole2 }}</div>@endif
                        ...
                        <td class="w-1/3 px-1">
                            ...
                            @if($_sigRole3)<div class="text-[10px] text-gray-500 mb-2">{{ $_sigRole3 }}</div>@endif
                ...
                <div class="flex justify-end gap-2 pt-3 border-t border-gray-200 dark:border-gray-700">
                    ...
                    @if(in_array($_form['status'], ['draft', 'submitted', 'diketahui']) && (auth()->user()->hasRole('admin') || auth()->user()->hasRole('teknisi')))
                        <a href="{{ route($_type . '.create') }}?formId={{ $_form['id'] }}"
                            wire:navigate class="px-4 py-2 bg-gray-600 text-white text-sm rounded-lg hover:bg-gray-700 transition-colors">Edit</a>
                    @endif
                </div>
            </div>
        </div>
