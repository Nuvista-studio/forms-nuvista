<div class="space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
            <h1 class="text-2xl font-bold text-primary">System Log</h1>
            <p class="text-sm text-muted mt-1">File log aplikasi (storage/logs/laravel.log)</p>
        </div>
        <div class="flex items-center gap-2">
            ...
            <button wire:click="clear" wire:confirm="Hapus semua isi file log?"
                class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-colors duration-200"
    ...
    <div class="glass-card p-4">
        <div class="flex flex-col sm:flex-row gap-3 items-end">
            <div class="relative flex-1">
                ...
                <input type="text" wire:model.live.debounce.300ms="search" placeholder="Cari pesan log..."
    ...
    @if($loading)
        <div class="glass-card p-8 text-center">
            ...
            <p class="text-sm text-muted mt-2">Memuat log...</p>
        </div>
    @elseif(empty($entries))
        <div class="glass-card p-8 text-center">
            ...
            <p class="text-sm text-muted">Tidak ada entri log</p>
        </div>
    @else
        <div class="glass-card p-4">
                ...
                <table class="w-full text-xs">
                    <thead>
                        <tr class="border-b" style="border-color: var(--color-border);">
                            <th class="px-3 py-2 text-left text-muted font-medium whitespace-nowrap">Waktu</th>
                            <th class="px-3 py-2 text-left text-muted font-medium whitespace-nowrap">Level</th>
                            <th class="px-3 py-2 text-left text-muted font-medium whitespace-nowrap">Pesan</th>
                        </tr>
                    </thead>
            ...
            <p class="text-xs text-muted mt-3">Menampilkan {{ count($entries) }} entri</p>
        </div>
    @endif
</div>
