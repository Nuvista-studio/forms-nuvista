                        ...
                        <div class="glass-card p-2 sticky top-24">
                            ...
                            <nav class="space-y-0.5">
                                ...
                                <a href="{{ route('admin.pdf-templates.index') }}" wire:navigate
                                    class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors duration-200 {{ request()->routeIs('admin.pdf-templates.*') ? 'admin-nav-active' : '' }}"
                                    style="{{ request()->routeIs('admin.pdf-templates.*') ? '' : 'color: var(--color-text-secondary);' }}">
                                    <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
